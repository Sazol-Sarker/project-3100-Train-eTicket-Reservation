    ...
    <div class="nav-wala">
     ...
     <div class="form-style">
       ...
       <form  method="POST">
           ...
           <input type="password" placeholder="Enter Account Password"  name="pwd" required>
...
if(isset($_POST['Log']))
{
    ...
    $sql="Select * from passenger where pnr_email='$email' ";
    $query=mysqli_query($con,$sql);
    $cnt=mysqli_num_rows($query);
    // echo "$cnt";
    if($cnt==1)//Existing Email check
    {
        //success
        $email_details=mysqli_fetch_assoc($query);
       
        $user_pass=$email_details['account_password'];
        if($user_pass==$pwd)
        {
        ...
        echo "Invalid User,Register first,Login failed!";
        }
