    ...
    <div id="form-heading">
        ...
        <div class="form-style">
            ...
            <label for="dest">Choose Destination:</label>
             ...
             <a href="send.php" target="_blank">
 <button type="submit" name="buy" id="buy-btn">Buy</button></a>
      </form> 
    </div>
...
if(isset($_POST['buy']))
{
    ...
    $sql="INSERT INTO reserved(pnr_email,train_name,source,destination,no_of_seat) values('$email','$trName','$source','$dest','$tktAmount')";
    $query=mysqli_query($con,$sql);

    mysqli_close($con);
    
    // alert about ticket confirmation & sending email
    include 'send.php';
}
?>